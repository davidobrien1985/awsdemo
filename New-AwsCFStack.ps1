...
New-CFNStack -StackName $CFStackName -TemplateURL https://s3-ap-southeast-2.amazonaws.com/cloudformation-templates-ap-southeast-2/Windows_Roles_And_Features.template -Parameter $params -ProfileName AWSProfile -Verbose
...
.\Send-SlackMessage.ps1 -message "@david $CFStackName has been created."